...
; and Desktop, with a proper "Uninstall T-Tech Studio Staff" entry in
...
;
; THIS IS THE STAFF VARIANT -- before running build_exe.py for this
; installer, App.jsx must have the Staff edits in place:
;   Spot A (~line 88)  -- NAV_GROUPS: comment out Dashboard, Invoices,
;                          Reports, Vendors, Materials, Advances,
;                          Audit Log, Archive, Export Data
;   Spot B (~line 834) -- renderPage(): comment out the matching
;                          case lines for those same pages
;   Spot C (~line 723) -- useState('Dashboard') -> useState('Jobs')
; Revert all three back to the full Admin version before building the
; Admin installer from this same App.jsx file.

#define MyAppName "T-Tech Studio Staff"
#define MyAppVersion "2.0.0"
#define MyAppPublisher "Prince Msowoya"
...
OutputBaseFilename=TTechStudio-Staff-Setup-{#MyAppVersion}
Compression=lzma
SolidCompression=yes
; A real, standard Windows uninstaller entry -- this is what makes
; "Uninstall T-Tech Studio Staff" appear in Windows Settings > Apps,
; with no extra work needed beyond what's already below.
...
Name: "autostart"; Description: "Start T-Tech Studio Staff automatically when I log in"; GroupDescription: "Startup:"
...
[Run]
Filename: "{app}\{#MyAppExeName}"; Description: "Launch T-Tech Studio Staff now"; Flags: nowait postinstall skipifsilent
