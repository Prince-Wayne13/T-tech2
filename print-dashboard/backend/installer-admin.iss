...
;
; THIS IS THE ADMIN VARIANT -- App.jsx should have every page enabled
; (Spots A/B/C all left as the full, unmodified Admin version) before
; you run build_exe.py for this installer.
