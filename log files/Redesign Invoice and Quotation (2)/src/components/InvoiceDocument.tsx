...
const DEFAULT_ITEMS: LineItem[] = [
  { id: "1", description: "A3 Full Colour Printing (Double Sided)", qty: 500, unit: "pages", rate: 250 },
  { id: "2", description: "Perfect Binding — A4 Booklets", qty: 50, unit: "copies", rate: 1800 },
  { id: "3", description: "Gloss Lamination (A4 Sheets)", qty: 50, unit: "sheets", rate: 400 },
]
...
export default function InvoiceDocument() {
  const [data, setData] = useState<InvoiceData>({
    ...
    clientAddress: "Capital Hill, Lilongwe, Malawi",
    clientPhone: "+265 1 789 422",
    notes:
      "Payment via bank transfer. National Bank of Malawi — T-Tech Suppliers & General Dealers Ltd. Account: 1234567890.",
    items: DEFAULT_ITEMS,
    amountPaid: 0,
    vatEnabled: true,
  })
  ...
  const vat = data.vatEnabled ? subtotal * VAT_RATE : 0
  const total = subtotal + vat
  const balance = Math.max(total - data.amountPaid, 0)
    ...
    <div className="invoice-root">
      ...
      <div className="no-print flex items-center justify-between gap-3 px-6 py-2.5 bg-[#2d3748] text-white sticky top-0 z-10">
        <div className="flex items-center gap-3">
          <TTechLogo size={28} />
          <span className="text-xs font-semibold tracking-wide text-white/80">Invoice Editor</span>
        </div>
      ...
      <div className="doc-page-bg bg-[#e8ecf0] min-h-screen py-10 px-4 flex justify-center print:bg-white print:py-0 print:block">
        <div className="doc-page bg-white w-full max-w-[794px] shadow-lg print:shadow-none flex flex-col">
          {/* Top rule — single thin line in muted steel */}
          ...
          <div className="flex flex-col gap-6 px-10 pt-8 pb-6 flex-1">
            ...
            <div className="flex justify-between items-start gap-4">
              ...
              <div className="text-right shrink-0">
                <div className="inline-block bg-[#2d3748] text-white text-[20px] font-black px-6 py-2 tracking-[0.18em]">
                  INVOICE
                </div>
                <div className="mt-3 space-y-1.5">
                  {[
                    { label: "Invoice No.", field: "invoiceRef" as const },
                  ...
                  <div className="flex items-center justify-end gap-2">
                    <span className="text-[9px] text-slate-400 uppercase tracking-widest font-medium">Date</span>
                    <input
                      type="date"
                  ...
                  <div className="flex items-center justify-end gap-2">
                    <span className="text-[9px] text-slate-400 uppercase tracking-widest font-medium">Due Date</span>
                    <input
                      type="date"
                      value={data.dueDate}
            ...
            <div className="flex gap-6">
              <div className="flex-1 border border-slate-200 p-4 bg-[#f9fafb]">
                <p className="text-[9px] font-bold text-slate-500 uppercase tracking-[0.12em] mb-2">Bill To</p>
                <input
              ...
              <table className="w-full border-collapse text-[11px]">
                <thead>
                  <tr className="bg-[#3d4f5c] text-white">
                    ...
                    <th className="text-left py-2.5 px-3 font-semibold text-[9px] uppercase tracking-wider">Description</th>
            ...
            <div className="flex justify-end">
              <div className="w-68">
                <div className="space-y-1.5 text-[12px]">
                  ...
                  <div className="flex justify-between font-bold text-[#2d3748] text-[13px] border-t border-slate-200 pt-2 gap-16">
                    <span>Total</span>
                    <span>{fmt(total)}</span>
                  </div>
                  <div className="flex justify-between items-center text-slate-500 gap-16">
                    ...
                    <input
                      ...
                      className="bg-transparent border-none outline-none text-right text-slate-600 font-medium w-32"
                    />
                  </div>
                  <div className="flex justify-between items-center font-bold text-white bg-[#3d4f5c] px-3 py-2.5 text-[12px] gap-16">
          ...
          <div className="border-t border-slate-200 bg-[#f9fafb] px-10 py-4 mt-auto">
            ...
            <p className="text-center text-[9px] text-slate-300 mt-1.5">
              {data.invoiceRef} · Issued: {fmtDate(data.issueDate)} · Due: {fmtDate(data.dueDate)}
            </p>
          </div>
