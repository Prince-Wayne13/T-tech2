...
const REPORT_TYPES = ['All', 'Monthly', 'Quarterly', 'Annual', 'Custom'];
...
export default function Reports() {
  ...
  const stats = [
    { label: 'Reports Generated', value: '24', sub: 'This year', icon: 'reports', color: 'primary' },
    { label: 'Pending Review', value: '3', sub: 'Awaiting approval', icon: 'clock', color: 'warning' },
    { label: 'Ready to Download', value: '18', sub: 'Available now', icon: 'check', color: 'teal' },
    { label: 'Avg. Generation', value: '4.2s', sub: 'Last 30 days', icon: 'reports', color: 'secondary' },
  ];
