...
export default function Receivables() {
  ...
  const filtered = RECEIVABLES_DATA.filter(r => {
  ...
  const stats = [
    { label: 'Total Outstanding', value: 'MK 3,530,000', sub: 'Unpaid invoices', icon: 'ar', color: 'warning' },
    { label: 'Overdue Amount', value: 'MK 1,270,000', sub: '2 past due', icon: 'alert', color: 'red' },
    { label: 'Avg. Collection', value: '18 days', sub: 'Last 30 days', icon: 'clock', color: 'teal' },
    { label: 'Collected This Month', value: 'MK 2,100,000', sub: '3 payments', icon: 'check', color: 'secondary' },
  ];
