...
export default function Expenses() {
  ...
  const stats = [
    { label: 'Total This Month', value: 'MK 980,000', sub: 'All categories', icon: 'expenses', color: 'primary' },
    { label: 'Pending Approval', value: 'MK 165,000', sub: '2 requests', icon: 'clock', color: 'warning' },
    { label: 'Top Category', value: 'Maintenance', sub: 'MK 450,000', icon: 'alert', color: 'secondary' },
    { label: 'Reimbursed', value: 'MK 95,000', sub: '1 payment', icon: 'check', color: 'teal' },
  ];
