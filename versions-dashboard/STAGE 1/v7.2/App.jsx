...
function PulseChart() {
  ...
  useEffect(() => {
    const i = setInterval(() => setSlide(s => (s + 1) % DATASETS.length), 10000);
  ...
  return (
    <div className="card pulse-chart">
      ...
      <div className="chart-legend">
        ...
        <div className="legend-net">Net Profit <strong>$10,400</strong><span className="trend-badge">↑ 12.3%</span></div>
      </div>
    </div>
  );
}
  ...
  return (
    <header className="topbar">
      ...
      <div className="topbar-search">
        <input type="text" placeholder="Search invoices, jobs, vendors..." />
      </div>
...
function QuickActions() {
  return (
    <div className="card quick-actions">
      ...
      <button className="cta-quick-entry"><Icon d={D.plus} size={14} /> Quick Entry</button>
    </div>
  );
}
