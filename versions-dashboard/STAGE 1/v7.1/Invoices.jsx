...
export default function Invoices() {
  ...
  const filtered = INVOICES_DATA.filter(i => {
  ...
  const stats = [
    { label: 'Outstanding', value: '$2,830', sub: 'Unpaid invoices', icon: 'invoices', color: 'warning' },
    { label: 'Overdue', value: '$420', sub: '1 invoice', icon: 'alert', color: 'red' },
    { label: 'Paid This Month', value: '$1,380', sub: '2 invoices', icon: 'check', color: 'teal' },
    { label: 'Avg. Payment Time', value: '11.2d', sub: 'Last 30 days', icon: 'clock', color: 'secondary' },
  ];
